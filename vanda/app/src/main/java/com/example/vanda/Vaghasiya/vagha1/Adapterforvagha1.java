...
public class Adapterforvagha1  extends RecyclerView.Adapter<Adapterforvagha1.ViewHolder> {
    List<ModelforVagha1> titles;
    Context context;
    LayoutInflater inflater;

    public Adapterforvagha1(Context ctx, List<ModelforVagha1> titles)
    {
        this.titles = titles;
        this.context = ctx;
